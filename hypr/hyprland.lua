...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("pkill swaybg; swaybg -i ~/Pictures/Wallpapers/Anime/wallhaven-pk61xe.png -m fill")
    hl.exec_cmd("mako")
end)
...
hl.config({
    general = {
        ...
        border_size = 3,
        col = {
            active_border   = "rgba(29,32,33,1)",
            inactive_border = "rgba(60,56,54,1)",
        },
...
-- TODO ADD BRIGHTNESS THINGS via ddcutil
